...
if __name__ == '__main__':
    # data_dir = sys.argv[1]
    # covariates = literal_eval(sys.argv[2])

    mf_dir = "/data/Coronavirus-Tweets/Covid19_Full_Dataset/mf_annotations/"
    issue_dir = "/data/Coronavirus-Tweets/Covid19_Full_Dataset/concerns_map_rt_fix_cleaned/"
    covariates = ['political','science','issue']
    
    aggregate_df(mf_dir,covariates,issue_dir,'_'.join(covariates))
